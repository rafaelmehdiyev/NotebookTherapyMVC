...
{
    public class FAQCategoryUpdateDtoValidator : AbstractValidator<FAQCategoryUpdateDto>
    {
        public FAQCategoryUpdateDtoValidator()
        {
            RuleFor(c => c.Name)
                .NotEmpty()
            ...
            .NotNull()
             .WithMessage("Don't Enter Null ")
               .MinimumLength(2).
                MaximumLength(255)
            .Must(ValidName)
                .WithMessage(Messages.EnterValid(Messages.FAQCategory));
