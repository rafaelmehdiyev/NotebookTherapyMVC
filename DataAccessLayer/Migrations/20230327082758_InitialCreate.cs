        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    CollectionHeaderImage = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CollectionItemBackgroundImage = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CollectionFooterImage = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CollectionColor = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CollectionItemColor = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CollectionButtonColor = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    isDeleted = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETUTCDATE()")
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductBundles_Bundles_BundleId",
                        column: x => x.BundleId,
